...
<body>
  ...
  <a href="https://github.com/iemabdullah/Url-Shorten/" target="_self">Fork me on GitHub</a>
</body>`
...
async function handleRequest(request) {
  ...
  if(!path){
    ...
    const html= await fetch("https://AbdullahMethod.github.io/Url-Shorten/"+config.theme+"/index.html")
  ...
  if (location) {
    if (config.safe_browsing_api_key){
      if(!(await is_url_safe(location))){
        let warning_page = await fetch("https://AbdullahMethod.github.io/Url-Shorten/safe-browsing.html")
    ...
    if (config.no_ref=="on"){
      let no_ref= await fetch("https://AbdullahMethod.github.io/Url-Shorten/no-ref.html")
